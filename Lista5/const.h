...
const std::string CTABLE_DEFAULT_NAME = "ctab";
const int CTABLE_DEFAULT_SIZE = 4;
const std::string CTABLE_NO_PARAM = "bezp.: ";
const std::string CTABLE_PARAMETR = "parametr: ";
